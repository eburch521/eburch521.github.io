...
include("header.php");
?>
<!-- display merch items in the accessories category -->
<h1>Accessories</h1>
<p>Check out our exclusive collection of accessories! Browse through our selection and add your favorite accessories to your cart.</p>
<?php
include("connDB.php");
$conn = connDB();
...
$sql = "SELECT * FROM Merch WHERE ItemCategory='Accessories';";
...
while ($row = mysqli_fetch_assoc($result)) {
    ...
    // obtain image from Images database
    $imageId = $row['ImageId'];
