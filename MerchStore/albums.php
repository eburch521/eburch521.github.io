<?php
// display merch items in the albums category
include("header.php");
?>
<h1>Albums</h1>
<p>Check out our exclusive collection of albums! Browse through our selection and add your favorite albums to your cart.</p>
<?php
include("connDB.php");
$conn = connDB();
...
$sql = "SELECT * FROM Merch WHERE ItemCategory='Albums';";
