...
?>
<h1>Posters</h1>
<p>Check out our collection of posters! We have a variety of designs to choose from. Browse through our selection and add your favorite posters to your cart.</p>
<?php
include("connDB.php");
$conn = connDB();
...
$sql = "SELECT * FROM Merch WHERE ItemCategory='Poster';";
